...
k_cache = torch.randint(0, 16, (2, 2, 64, 128), dtype=torch.uint8, device="cuda")
k_cache_pack = torch.randint(0, 16, (2, 2, 64, 64), dtype=torch.uint8, device="cuda")
print(k_cache[0, 0, 0, :])
# rearrange
for i in range(2):
    for j in range(2):
